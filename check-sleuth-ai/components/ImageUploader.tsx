  ...
  return (
    <div className="max-w-2xl mx-auto text-center">
      <div className="bg-slate-800 p-8 rounded-xl border border-slate-700 shadow-2xl">
        <h2 className="text-3xl font-bold text-slate-100 mb-2">Analyze Your Check</h2>
        <p className="text-slate-400 mb-6">Upload an image of a bank check and let our AI assistant extract and analyze the details for you.</p>
        <div
        ...
        {isProcessing && (
          <div className="mt-6 flex items-center justify-center space-x-2">
            ...
            <p className="text-slate-300">AI is analyzing your check...</p>
          </div>
        )}
      </div>
    </div>
